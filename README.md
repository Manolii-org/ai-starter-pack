...
Go-forward release: **`v1.8.0`** (annotated tag on `main`).

```yaml
# Reusable workflows
uses: Manolii-org/ai-starter-pack/.github/workflows/ci-reusable.yml@v1.8.0
# Plugin
# /plugin install manolii-framework@v1.8.0
```

Renovate preset: `extends: ["github>Manolii-org/ai-starter-pack"]` (optionally pin `#v1.8.0`).
