...
echo ""
echo "  NOTICE: the checked deploy/litellm-proxy config is a supported legacy"
echo "  example, not the canonical product source. New deployments should use"
echo "  the verified release and profile flow in litellm-product/README.md."
echo ""
